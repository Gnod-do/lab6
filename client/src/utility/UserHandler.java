...
import src.App;
import main.data.Coordinates;
import main.data.FormOfEducation;
import main.data.Person;
import main.data.Semester;
import main.exceptions.CommandUsageException;
import main.exceptions.IncorrectInputInScriptException;
import main.exceptions.ScriptRecursionException;
...
public class UserHandler {
    ...
    private GroupRaw generateGroupUpdate() throws IncorrectInputInScriptException {
        GroupAsker groupAsker = new GroupAsker(userScanner);
        if(fileMode()) groupAsker.setFileMode();
        String name = groupAsker.askQuestion("Хотите изменить координаты группа?") ?
                groupAsker.askName() : null;
        Coordinates coordinates = groupAsker.askQuestion("Хотите изменить здоровье группа?") ?
